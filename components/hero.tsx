...
const HeroHeader = () => {
  return (
    <section className="pb-12 pt-4 text-center lg:items-center lg:gap-8 h-screen bg-[url('/bg.jpeg')] bg-no-repeat bg-cover">
      <div className="flex flex-1 flex-col items-center gap-4 text-center lg:gap-8">
        <div className="space-y-4 backdrop-blur-md p-6 px-8 rounded-full pt-20">
